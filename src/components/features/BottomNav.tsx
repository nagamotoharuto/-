          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-[#1a4d2e]" : "text-[#6b5e52]"
              )}
            >
              <div className="relative">
                <Icon size={22} strokeWidth={isActive ? 2.5 : 1.8} />
                {showBadge && totalItems > 0 && (
                  <span className="absolute -top-2 -right-2 bg-[#c8843a] text-white text-xs rounded-full w-4 h-4 flex items-center justify-center font-bold leading-none">
