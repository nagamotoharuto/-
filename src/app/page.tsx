...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f3] flex flex-col pb-20">
      {/* Hero */}
      <div className="bg-[#1a4d2e] text-white px-4 pt-12 pb-10">
        <div className="max-w-md mx-auto text-center">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-[#c8843a] rounded-full flex items-center justify-center">
              <ChefHat size={32} className="text-white" />
            </div>
          </div>
          <h1 className="text-2xl font-black tracking-wide mb-1">学内ベーカリー</h1>
          <p className="text-sm text-green-200 mb-4">事前予約サービス</p>
      ...
      <div className="max-w-md mx-auto w-full px-4 py-6">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            ...
            >
              <p className="text-xs font-black text-[#c8843a] mb-2">STEP {step}</p>
              <Icon size={28} className="mx-auto text-[#1a4d2e] mb-2" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#e8e0d8] p-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="例：たろう"
              maxLength={20}
              className="w-full border border-[#e8e0d8] rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1a4d2e] bg-[#fdf8f3]"
            />
                ...
                <button
                  ...
                  className={`py-2.5 rounded-xl text-sm font-bold border transition-colors ${
                    userType === t.value
                      ...
                      : "bg-white text-[#1a1a1a] border-[#e8e0d8] hover:border-[#1a4d2e]"
                  }`}
                >
                  {t.label}
                </button>
          ...
          <button
            onClick={handleStart}
            className="w-full bg-[#1a4d2e] text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 text-base hover:bg-[#2d6b42] transition-colors active:scale-95"
          >
            メニューを見る
            <ArrowRight size={18} />
          </button>
