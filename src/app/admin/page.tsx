    ...
    <div className="min-h-screen bg-[#8B1A2C] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[#F5C0C8] text-sm mt-1">University Bakery</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              ...
              className="w-full bg-[#8B1A2C] text-white rounded-xl py-3 font-bold disabled:opacity-60 hover:bg-[#A52235] transition-colors"
            >
              {loading ? "確認中..." : "ログイン"}
            </button>
          </form>
        ...
        <Link
          href="/"
          className="mt-5 flex items-center justify-center gap-1.5 text-[#F5C0C8] hover:text-white text-sm transition-colors"
        >
          <Home size={14} />
          ホームに戻る
        </Link>
