    ...
    <div className="min-h-screen bg-[#fdf8f3] flex flex-col pb-32">
      ...
      <div className="fixed bottom-16 left-0 right-0 px-4 z-40">
        <div className="max-w-md mx-auto">
          <button
            onClick={handleNext}
            className="w-full bg-[#8B1A2C] text-white rounded-2xl py-4 flex items-center justify-center gap-2 font-bold text-base shadow-lg hover:bg-[#A52340] transition-colors"
          >
            お支払い方法へ
            <ArrowRight size={18} />
          </button>
