    ...
    <div className="min-h-screen bg-[#fdf8f3] flex flex-col pb-32">
      ...
      <div className="max-w-md mx-auto w-full px-4">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d8] shadow-sm p-4 mb-6">
          <div className="flex items-start gap-3">
            <MapPin size={18} className="text-[#1a4d2e] mt-0.5 flex-shrink-0" />
            <div>
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d8] shadow-sm p-5 mb-4">
          ...
          <select
            ...
            className="w-full border border-[#e8e0d8] rounded-xl px-4 py-3 bg-[#fdf8f3] text-sm font-medium text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#1a4d2e] appearance-none cursor-pointer"
          >
        ...
        {selected && (
          <div className="bg-[#1a4d2e]/10 border border-[#1a4d2e]/20 rounded-2xl p-4 flex items-center gap-3">
            <Clock size={20} className="text-[#1a4d2e]" />
            <div>
              <p className="text-xs text-[#1a4d2e] font-medium">受け取り予定時刻</p>
              <p className="text-xl font-black text-[#1a4d2e]">{selected}</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="fixed bottom-16 left-0 right-0 px-4 z-40">
        <div className="max-w-md mx-auto">
          <button
            onClick={handleNext}
            className="w-full bg-[#1a4d2e] text-white rounded-2xl py-4 flex items-center justify-center gap-2 font-bold text-base shadow-lg hover:bg-[#2d6b42] transition-colors"
          >
            お支払い方法へ
            <ArrowRight size={18} />
          </button>
