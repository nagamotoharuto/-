...
export default function ConfirmPage() {
    ...
    return (
      <div className="min-h-screen bg-[#fdf8f3] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push("/")}
            className="bg-[#1a4d2e] text-white px-6 py-3 rounded-2xl font-bold"
          >
            ホームへ
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#1a4d2e] flex flex-col pb-20">
      ...
      <div className="flex-shrink-0 px-4 pt-12 pb-8 text-center text-white">
        ...
        <p className="text-sm text-green-200 mb-1">注文を承りました</p>
        ...
        <div className="inline-block bg-white/10 rounded-2xl px-6 py-3 mt-2">
          <p className="text-xs text-green-200 mb-1">ニックネーム</p>
      ...
      <div className="mx-4 bg-white/10 rounded-2xl p-4 mb-3 text-white text-center">
        <div className="flex items-center justify-center gap-2 mb-1">
          ...
          <span className="text-xs text-green-200">受け取り時間</span>
        </div>
      ...
      <div className="mx-4 bg-white rounded-2xl shadow-sm overflow-hidden flex-1">
        ...
        <div className="bg-[#f5f0eb] px-5 py-4 border-b border-[#e8e0d8]">
          <div className="flex justify-between items-center">
            ...
            <span className="text-2xl font-black text-[#1a4d2e]">#{order.orderNumber}</span>
          </div>
        </div>
        ...
        <div className="px-5 py-4 border-b border-[#e8e0d8]">
          <div className="flex items-start gap-3">
            <MapPin size={16} className="text-[#1a4d2e] mt-0.5 flex-shrink-0" />
            <div>
          ...
          <ol className="space-y-2">
            {[
              ...
              <li key={i} className="flex items-start gap-2 text-xs text-[#6b5e52]">
                <span className="w-4 h-4 bg-[#1a4d2e] text-white rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold">
                  {i + 1}
                </span>
                {step}
              </li>
        ...
        <div className="px-5 py-4 border-b border-[#e8e0d8]">
          ...
          <div className="border-t border-[#e8e0d8] mt-3 pt-3 flex justify-between items-center">
            ...
            <span className="text-lg font-black text-[#1a4d2e]">{formatPrice(order.totalAmount)}</span>
          </div>
        ...
        <div className="px-5 py-4 flex gap-3">
          <button
            onClick={() => router.push("/")}
            className="flex-1 border-2 border-[#1a4d2e] text-[#1a4d2e] rounded-2xl py-3 font-bold text-sm flex items-center justify-center gap-2"
          >
            <Home size={16} />
            ホームへ
          </button>
          <button
            ...
            className="flex-1 bg-[#1a4d2e] text-white rounded-2xl py-3 font-bold text-sm flex items-center justify-center gap-2"
          >
            <User size={16} />
            スタンプ確認
          </button>
